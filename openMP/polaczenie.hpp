...
std::vector<int> geneticAlgorithmParalell(std::vector<std::vector<int>> t,std::vector<std::vector<int>> broken,std::vector <int> greedyResult, int n);
std::vector<int> geneticAlgorithmSequency(std::vector<std::vector<int>> t,std::vector<std::vector<int>> broken,std::vector <int> greedyResult, int n);
